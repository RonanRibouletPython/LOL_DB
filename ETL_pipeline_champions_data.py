...
def insert_name(username)-> str:
    ...
    query_players_names = """
            SELECT DISTINCT champion_stats.player_id, summoners.game_name
            FROM summoners
...
def ETL_pipeline_champions_data(id, name)-> None:
...
def ETL_pipeline_season_data(id, name)-> None:
...
def ETL_pipeline_summoner_data(id, name)-> None:
...
def ETL_pipeline_season_history_data(id, name)-> None:
...
def ETL_pipeline_recent_games_data(id, name)-> None:
